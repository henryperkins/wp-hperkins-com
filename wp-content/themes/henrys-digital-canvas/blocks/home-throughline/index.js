			...
			return el(
				...
				el(
					...
					el(
						...
						el( Button, { variant: 'secondary', onClick: addParagraph }, __( 'Add paragraph', 'henrys-digital-canvas' ) )
					),
					el(
						PanelBody,
				...
				el(
					...
					el(
						...
						quote.eyebrow ? el( 'p', { className: 'hdc-home-page__throughline-quote-header' }, quote.eyebrow ) : null,
						el(
							'blockquote',
