...
| `2026-06-05-homepage-core-block-sync-phase-3-plan.md` | Open execution plan | Recent Writing core Query Loop + `reading_time` post meta, deletion of the six home child blocks, referrer audit, and final parity pass. |
