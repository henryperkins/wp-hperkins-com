...
if (typeof document !== "undefined" && process.env.NODE_ENV !== "test" && !document.head.querySelector("style[data-wp-hash='3eb7a8872f']")) {
...
var CloseIcon = forwardRef(
  function NoticeCloseIcon({ className, icon = closeSmall, label = __("Dismiss"), ...props }, ref) {
    return /* @__PURE__ */ jsx(
      IconButton,
      {
        ...props,
        ref,
        className: clsx(style_default["close-icon"], className),
        variant: "minimal",
        size: "small",
        tone: "neutral",
        icon,
