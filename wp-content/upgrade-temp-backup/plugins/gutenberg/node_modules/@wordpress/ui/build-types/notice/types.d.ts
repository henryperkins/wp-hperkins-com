...
export interface CloseIconProps extends Omit<IconButtonProps, 'loading' | 'loadingAnnouncement' | 'variant' | 'size' | 'tone' | 'label' | 'icon'> {
    /**
...
export interface ActionButtonProps extends Omit<ButtonProps, 'size' | 'tone'> {
    /**
