...
// packages/ui/src/dialog/title.tsx
var title_exports = {};
...
var Title = (0, import_element.forwardRef)(
  function DialogTitle({ className, render, ...props }, forwardedRef) {
    const validationContext = (0, import_context.useDialogValidationContext)();
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ...
      {
        ref: mergedRef,
        className: (0, import_clsx.default)(style_default.title, className),
        render,
        ...props
      }
    );
