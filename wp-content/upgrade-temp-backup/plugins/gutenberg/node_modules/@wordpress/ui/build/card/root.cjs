...
// packages/ui/src/card/root.tsx
var Root = (0, import_element.forwardRef)(function Card({ render, ...restProps }, ref) {
  const mergedClassName = (0, import_clsx.default)(style_default.root, resets_default["box-sizing"]);
  const element = (0, import_react.useRender)({
    defaultTagName: "div",
    render,
    ref,
    props: (0, import_react.mergeProps)({ className: mergedClassName }, restProps)
  });
  return element;
});
