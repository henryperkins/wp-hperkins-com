...
export declare const MenuItem: import("react").ForwardRefExoticComponent<Pick<import("../button/types").ButtonAsButtonProps, "isDestructive"> & {
    ...
    label?: string;
} & Omit<Omit<import("react").DetailedHTMLProps<import("react").ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>, "ref">, "className" | "role" | "children" | "shortcut" | "label" | "as" | "suffix" | "icon" | "iconPosition" | "isDestructive" | "info" | "isSelected"> & import("react").RefAttributes<HTMLButtonElement>>;
