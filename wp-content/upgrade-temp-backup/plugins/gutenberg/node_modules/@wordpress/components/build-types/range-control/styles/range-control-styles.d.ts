import type { RangeMarkProps, ThumbProps, TooltipProps, TrackProps, WrapperProps, RangeControlProps } from '../types';
...
export declare const InputNumber: import("@emotion/styled").StyledComponent<Omit<import("../../input-control/types").InputControlProps, "max" | "min" | "type" | "value" | "step" | "required" | "isDragEnabled"> & {
