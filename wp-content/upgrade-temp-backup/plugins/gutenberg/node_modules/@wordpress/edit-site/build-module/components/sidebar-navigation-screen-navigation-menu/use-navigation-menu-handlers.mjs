...
import { postType } from "./index.mjs";
...
function useSaveNavigationMenu() {
  const { getEditedEntityRecord } = useSelect((select) => {
    const { getEditedEntityRecord: getEditedEntityRecordSelector } = select(coreStore);
    return {
...
export {
  useNavigationMenuHandlers as default
};
//# sourceMappingURL=use-navigation-menu-handlers.mjs.map
