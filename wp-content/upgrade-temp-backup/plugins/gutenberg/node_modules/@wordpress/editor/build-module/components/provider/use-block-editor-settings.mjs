  ...
  return useMemo(() => {
    const blockEditorSettings = {
      ...
      [selectBlockPatternsKey]: (select) => {
        const { hasFinishedResolution, getBlockPatternsForPostType } = unlock(select(coreStore));
...
export {
  use_block_editor_settings_default as default
};
//# sourceMappingURL=use-block-editor-settings.mjs.map
