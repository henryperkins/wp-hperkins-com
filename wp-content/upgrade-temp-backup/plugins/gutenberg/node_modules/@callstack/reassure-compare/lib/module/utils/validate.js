...
const performanceEntriesSchema = z.array(performanceEntrySchema).refine(val => !hasDuplicateValues(val.map(val => val.name)), {
...
export function parsePerformanceEntries(entries) {
