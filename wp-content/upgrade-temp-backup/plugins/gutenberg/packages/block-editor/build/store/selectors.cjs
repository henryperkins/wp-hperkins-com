...
var __unstableGetBlockWithoutInnerBlocks = (0, import_data.createSelector)(
  (state, clientId) => {
    const block = state.blocks.byClientId.get(clientId);
    if (!block) {
      return null;
...
var __unstableGetClientIdWithClientIdsTree = (0, import_data.createSelector)(
  (state, clientId) => {
...
var __unstableGetClientIdsTree = (0, import_data.createSelector)(
  (state, rootClientId = "") => {
    (0, import_deprecated.default)(
...
var getClientIdsOfDescendants = (0, import_data.createSelector)(
  (state, rootIds) => {
...
var getGlobalBlockCount = (0, import_data.createSelector)(
  (state, blockName) => {
...
var getBlocksByName = (0, import_data.createSelector)(
  (state, blockName) => {
    if (!blockName) {
      return EMPTY_ARRAY;
    }
...
var getBlocksByClientId = (0, import_data.createSelector)(
...
var getBlockNamesByClientId = (0, import_data.createSelector)(
...
var getBlockParents = (0, import_data.createSelector)(
...
var getBlockParentsByBlockName = (0, import_data.createSelector)(
...
var getSelectedBlockClientIds = (0, import_data.createSelector)(
  (state) => {
    const { selectionStart, selectionEnd } = state.selection;
...
var getMultiSelectedBlocks = (0, import_data.createSelector)(
  (state) => {
...
var isAncestorMultiSelected = (0, import_data.createSelector)(
  (state, clientId) => {
...
var getBlockInsertionPoint = (0, import_data.createSelector)(
  (state) => {
...
var canInsertBlockTypeUnmemoized = (state, blockName, rootClientId = null) => {
  ...
  if (blockEditingMode === "disabled" && blockName !== (0, import_blocks.getDefaultBlockName)()) {
    return false;
  }
  ...
  if ((isParentSectionBlock || blockEditingMode === "contentOnly") && !(0, import_private_selectors.isContainerInsertableToInContentOnlyMode)(
    ...
    if (blockName === (0, import_blocks.getDefaultBlockName)()) {
      const existingBlocks = getBlockOrder(state, rootClientId);
      const hasDefaultBlock = existingBlocks.some(
        (clientId) => getBlockName(state, clientId) === (0, import_blocks.getDefaultBlockName)()
      );
      if (!hasDefaultBlock) {
        return false;
      }
...
var canInsertBlockType = (0, import_data.createRegistrySelector)(
...
function canRemoveBlock(state, clientId) {
  ...
  const blockName = getBlockName(state, clientId);
  if ((isParentSectionBlock || rootBlockEditingMode === "contentOnly" || blockName === (0, import_blocks.getDefaultBlockName)()) && !(0, import_private_selectors.isContainerInsertableToInContentOnlyMode)(
    state,
    getBlockName(state, clientId),
    rootClientId
  )) {
    if (blockName === (0, import_blocks.getDefaultBlockName)()) {
      ...
      const defaultBlocks = existingBlocks.filter(
        (id) => getBlockName(state, id) === (0, import_blocks.getDefaultBlockName)()
      );
...
var buildBlockTypeItem = (state, { buildScope = "inserter" }) => (blockType) => {
  ...
  const blockVariations = (0, import_blocks.getBlockVariations)(blockType.name, "block");
  const allVariations = [
    ...inserterVariations,
...
var getInserterItems = (0, import_data.createRegistrySelector)(
  (select) => (0, import_data.createSelector)(
...
var getBlockTransformItems = (0, import_data.createRegistrySelector)(
  (select) => (0, import_data.createSelector)(
...
var getAllowedBlocks = (0, import_data.createRegistrySelector)(
  (select) => (0, import_data.createSelector)(
...
var __experimentalGetAllowedBlocks = (0, import_data.createSelector)(
  (state, rootClientId = null) => {
    (0, import_deprecated.default)(
...
var __experimentalGetParsedPattern = (0, import_data.createRegistrySelector)(
...
var __experimentalGetAllowedPatterns = (0, import_data.createRegistrySelector)(
  (select) => {
...
var getPatternsByBlockTypes = (0, import_data.createRegistrySelector)(
  (select) => (0, import_data.createSelector)(
...
var __experimentalGetPatternsByBlockTypes = (0, import_data.createRegistrySelector)(
  (select) => {
    (0, import_deprecated.default)(
...
var __experimentalGetPatternTransformItems = (0, import_data.createRegistrySelector)(
  (select) => (0, import_data.createSelector)(
    (state, blocks, rootClientId = null) => {
      if (!blocks) {
        return EMPTY_ARRAY;
...
var __experimentalGetReusableBlockTitle = (0, import_data.createRegistrySelector)(
  (select) => (0, import_data.createSelector)(
    (state, ref) => {
      (0, import_deprecated.default)(
...
var __unstableGetVisibleBlocks = (0, import_data.createSelector)(
  (state) => {
...
var isUngroupable = (0, import_data.createRegistrySelector)(
  (select) => (state, clientId = "") => {
    const _clientId = clientId || getSelectedBlockClientId(state);
    if (!_clientId) {
      return false;
    }
    if ((0, import_private_selectors.isSectionBlock)(state, _clientId)) {
      return false;
    }
...
var isGroupable = (0, import_data.createRegistrySelector)(
...
function __unstableGetTemporarilyEditingAsBlocks(state) {
  ...
  return (0, import_private_selectors.getEditedContentOnlySection)(state);
}
