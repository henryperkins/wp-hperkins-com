...
var use_media_upload_settings_exports = {};
__export(use_media_upload_settings_exports, {
  default: () => use_media_upload_settings_default
});
module.exports = __toCommonJS(use_media_upload_settings_exports);
...
//# sourceMappingURL=use-media-upload-settings.cjs.map
