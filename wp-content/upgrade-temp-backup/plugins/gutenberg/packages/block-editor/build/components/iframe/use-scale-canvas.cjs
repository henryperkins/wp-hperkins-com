...
var use_scale_canvas_exports = {};
__export(use_scale_canvas_exports, {
  useScaleCanvas: () => useScaleCanvas
});
module.exports = __toCommonJS(use_scale_canvas_exports);
...
function useScaleCanvas({
  ...
  const startAnimationRef = (0, import_element.useRef)(false);
  const animationRef = (0, import_element.useRef)(null);
  ...
  const previousIsZoomedOut = (0, import_element.useRef)(false);
  (0, import_element.useEffect)(() => {
...
//# sourceMappingURL=use-scale-canvas.cjs.map
