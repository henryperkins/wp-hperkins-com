...
var import_writing_flow = require("../writing-flow/index.cjs");
var import_get_compatibility_styles = require("./get-compatibility-styles.cjs");
var import_use_scale_canvas = require("./use-scale-canvas.cjs");
var import_store = require("../../store/index.cjs");
var import_jsx_runtime = require("react/jsx-runtime");
var ViewportWidthProvider = import_compose.useViewportMatch.__experimentalWidthProvider;
...
function Iframe({
  ...
  readonly,
  forwardedRef: ref,
  title = (0, import_i18n.__)("Editor canvas"),
  ...props
}) {
  const { resolvedAssets, isPreviewMode } = (0, import_data.useSelect)((select) => {
  ...
  const [iframeDocument, setIframeDocument] = (0, import_element.useState)();
  ...
  const iframe = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "iframe",
      {
        ...
        ref: (0, import_compose.useMergeRefs)([ref, setRef]),
        tabIndex,
        src,
        title,
        onKeyDown: (event) => {
        ...
        children: iframeDocument && (0, import_element.createPortal)(
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "body",
            {
              ...
              children: [
                contentResizeListener,
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.__experimentalStyleProvider, { document: iframeDocument, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ViewportWidthProvider, { value: containerWidth, children }) })
              ]
            }
          ),
...
function IframeIfReady(props, ref) {
  const isInitialised = (0, import_data.useSelect)(
    (select) => select(import_store.store).getSettings().__internalIsInitialized,
    []
  );
  if (!isInitialised) {
    return null;
  }
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Iframe, { ...props, forwardedRef: ref });
}
var iframe_default = (0, import_element.forwardRef)(IframeIfReady);
