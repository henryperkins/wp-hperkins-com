...
} & import("react").RefAttributes<any> & Omit<Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>, "ref">, "children" | "variant" | "color" | "display" | "letterSpacing" | "lineHeight" | "size" | "as" | "align" | keyof import("react").RefAttributes<any> | "isDestructive" | "ellipsis" | "isBlock" | "weight" | "adjustLineHeightForInnerControls" | "highlightEscape" | "highlightCaseSensitive" | "highlightSanitize" | "optimizeReadabilityFor" | "truncate" | "upperCase" | "highlightWords" | "ellipsizeMode" | "limit" | "numberOfLines" | "level"> & {
    as?: keyof import("react").JSX.IntrinsicElements | undefined;
} & {
    theme?: import("@emotion/react").Theme;
}, {}, {}>;
