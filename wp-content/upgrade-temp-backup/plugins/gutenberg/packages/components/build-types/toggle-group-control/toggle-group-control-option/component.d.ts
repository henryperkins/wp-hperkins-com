...
export declare const ToggleGroupControlOption: import("react").ForwardRefExoticComponent<Pick<import("../types").ToggleGroupControlOptionBaseProps, "value" | "showTooltip"> & {
    label: string;
} & Omit<Omit<import("react").DetailedHTMLProps<import("react").ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>, "ref">, "children" | "value" | "label" | "as" | "showTooltip"> & import("react").RefAttributes<any>>;
