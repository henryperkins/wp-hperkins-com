...
export default meta;
export declare const Default: import("storybook/internal/csf").AnnotatedStoryFn<import("@storybook/react-vite").ReactRenderer, Pick<import("../../input-control/types").InputControlProps, "help" | "value"> & {
...
} & Omit<Omit<import("react").DetailedHTMLProps<import("react").InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>, "ref">, "children" | "onClose" | "help" | "onChange" | "onDrag" | "onDragEnd" | "onDragStart" | "size" | "value" | "label" | "as" | "placeholder" | "__next40pxDefaultSize" | "hideLabelFromVision" | "__nextHasNoMarginBottom"> & import("react").RefAttributes<HTMLInputElement>>;
