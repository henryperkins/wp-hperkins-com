 ...
 */
export const store: import("@wordpress/data").StoreDescriptor<import("@wordpress/data").ReduxStoreConfig<any, {
    ...
    receiveEntityRecords(kind: string, name: string, records: any[] | any, query?: any | null, invalidateCache?: boolean | null, edits?: any | null, meta?: any | null): any;
    ...
    receiveRevisions: (kind: string, name: string, recordKey: number | string, records: any[] | any, query: any | null, invalidateCache: (boolean | null) | undefined, meta: any | null) => ({ dispatch, resolveSelect }: {
        dispatch: any;
        resolveSelect: any;
    }) => Promise<void>;
