...
var ResizableBoxContainer = forwardRef(
...
function ToolbarEditButton({
  ...
  return /* @__PURE__ */ jsx(BlockControls, { group: "other", children: /* @__PURE__ */ jsx(
    MediaReplaceFlow,
    {
      mediaId,
      mediaURL: mediaUrl,
...
function MediaContainer(props, ref) {
  ...
  if (mediaUrl || featuredImageURL || useFeaturedImage) {
    ...
    const mediaTypeRenderers = {
      image: () => useFeaturedImage && featuredImageURL ? /* @__PURE__ */ jsx(
        "img",
        {
          ref: refMedia,
      ...
      video: () => /* @__PURE__ */ jsx("video", { controls: true, ref: refMedia, src: mediaUrl })
    };
    return /* @__PURE__ */ jsxs(
      ResizableBoxContainer,
      {
        ...
        children: [
          ...
          isTemporaryMedia && /* @__PURE__ */ jsx(Spinner, {}),
          !useFeaturedImage && /* @__PURE__ */ jsx(PlaceholderContainer, { ...props }),
          !featuredImageURL && useFeaturedImage && /* @__PURE__ */ jsx(
            Placeholder,
            {
  ...
  return /* @__PURE__ */ jsx(PlaceholderContainer, { ...props });
}
var media_container_default = forwardRef(MediaContainer);
export {
  media_container_default as default
};
//# sourceMappingURL=media-container.mjs.map
