...
function PostExcerptEditor({
  ...
  if (!postType || !postId) {
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx("div", { ...blockProps, children: /* @__PURE__ */ jsx("p", { children: __("This block will display the excerpt.") }) })
    ] });
  }
  if (isProtected && !userCanEdit) {
    return /* @__PURE__ */ jsx("div", { ...blockProps, children: /* @__PURE__ */ jsx(Warning, { children: __(
      "The content is currently protected and does not have the available excerpt."
    ) }) });
  }
  const readMoreLink = /* @__PURE__ */ jsx(
    RichText,
    {
      identifier: "moreText",
  ...
  const excerptContent = isEditable ? /* @__PURE__ */ jsx(
    RichText,
    {
  ...
  ) : /* @__PURE__ */ jsx("p", { className: excerptClassName, children: !isTrimmed ? rawOrRenderedExcerpt || __("No excerpt found") : trimmedExcerpt + ELLIPSIS });
  return /* @__PURE__ */ jsxs(Fragment, { children: [
