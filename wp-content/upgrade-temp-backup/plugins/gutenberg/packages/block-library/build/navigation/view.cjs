...
var { state, actions } = (0, import_interactivity.store)(
  "core/navigation",
  {
    state: {
      get roleAttribute() {
    ...
    actions: {
      openMenuOnHover() {
        const { type, overlayOpenedBy } = (0, import_interactivity.getContext)();
      ...
      handleMenuKeydown: (0, import_interactivity.withSyncEvent)((event) => {
        const { type, firstFocusableElement, lastFocusableElement } = (0, import_interactivity.getContext)();
