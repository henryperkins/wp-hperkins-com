...
var Tab = (0, import_element.forwardRef)(function Tab2({ className, children, ...otherProps }, forwardedRef) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    ...
    {
      ref: forwardedRef,
      className: (0, import_clsx.default)(style_default.tab, className),
      ...otherProps,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: style_default["tab-children"], children }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icon.Icon, { icon: import_icons.chevronRight, className: style_default["tab-chevron"] })
      ]
    }
  );
});
