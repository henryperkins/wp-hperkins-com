...
// packages/ui/src/dialog/footer.tsx
var footer_exports = {};
...
// packages/ui/src/dialog/footer.tsx
var Footer = (0, import_element.forwardRef)(function DialogFooter({ className, render, ...props }, ref) {
  const element = (0, import_react.useRender)({
    render,
    ref,
    props: (0, import_react.mergeProps)(props, {
      className: (0, import_clsx.default)(style_default.footer, className)
    })
  });
  return element;
});
