...
var Item = (0, import_element.forwardRef)(
  function Item2({ className, value, size = "default", children = value, ...restProps }, ref) {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_icon.Icon,
            {
              ...
              className: (0, import_clsx.default)(
                item_popup_default["item-indicator"],
                item_popup_default["item-indicator-icon"]
              ),
              size: size === "small" ? 20 : 24
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_select.Select.ItemText, { children })
        ]
      }
    );
  }
