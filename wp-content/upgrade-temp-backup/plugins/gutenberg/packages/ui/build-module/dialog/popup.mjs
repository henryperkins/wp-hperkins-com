...
import { DialogValidationProvider } from "./context.mjs";
...
var Popup = forwardRef(function DialogPopup({ className, size = "medium", children, ...props }, ref) {
  return /* @__PURE__ */ jsxs(_Dialog.Portal, { children: [
    /* @__PURE__ */ jsx(_Dialog.Backdrop, { className: style_default.backdrop }),
    /* @__PURE__ */ jsx(ThemeProvider, { children: /* @__PURE__ */ jsx(
      _Dialog.Popup,
      {
        ...
        ...props,
        children: /* @__PURE__ */ jsx(DialogValidationProvider, { children })
      }
    ) })
  ] });
});
