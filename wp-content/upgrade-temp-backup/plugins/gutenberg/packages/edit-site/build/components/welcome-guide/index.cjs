...
var import_editor = __toESM(require("./editor.cjs"));
...
function WelcomeGuide({ postType }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_editor.default, {}),
    postType === "page" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_page.default, {}),
    postType === "wp_template" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_template.default, {})
  ] });
}
