...
var selectTemplateParts = createSelector(
...
var selectThemePatterns = createSelector(
  (select) => {
...
var selectPatterns = createSelector(
...
var selectUserPatterns = createSelector(
...
export {
  use_patterns_default as default,
  useAugmentPatternsWithPermissions,
  usePatterns
};
//# sourceMappingURL=use-patterns.mjs.map
