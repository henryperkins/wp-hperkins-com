 ...
 */
import type { NormalizedField, Operator, Option, SortDirection } from './field-api';
...
export type View = ViewList | ViewGrid | ViewTable | ViewPickerGrid | ViewPickerTable | ViewActivity;
...
export interface ActionModal<Item> extends ActionBase<Item> {
     ...
     */
    RenderModal: ({ items, closeModal, onActionPerformed, }: RenderModalProps<Item>) => ReactElement;
    /**
...
export type ViewPickerBaseProps<Item> = Omit<ViewBaseProps<Item>, 'view' | 'onChangeView' | 'isItemClickable' | 'onClickItem' | 'renderItemLink' | 'getItemLevel'> & {
    view: View;
    onChangeView: (view: View) => void;
};
...
export interface ViewPickerGridProps<Item> extends Omit<ViewPickerBaseProps<Item>, 'view'> {
    view: ViewPickerGrid;
}
export interface ViewPickerTableProps<Item> extends Omit<ViewPickerBaseProps<Item>, 'view'> {
