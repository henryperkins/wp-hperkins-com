...
var composite_grid_exports = {};
__export(composite_grid_exports, {
  default: () => CompositeGrid
});
module.exports = __toCommonJS(composite_grid_exports);
...
function CompositeGrid({
  ...
  const { paginationInfo, resizeObserverRef } = (0, import_element.useContext)(import_dataviews_context.default);
