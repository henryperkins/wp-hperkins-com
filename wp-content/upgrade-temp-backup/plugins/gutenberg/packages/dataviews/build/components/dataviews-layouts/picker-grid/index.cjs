...
var picker_grid_exports = {};
__export(picker_grid_exports, {
  default: () => picker_grid_default
});
module.exports = __toCommonJS(picker_grid_exports);
...
function GridItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    import_components.Composite.Item,
    {
      ...
      className: (0, import_clsx.default)("dataviews-view-picker-grid__card", {
      ...
      children: [
        showMedia && renderedMediaField && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dataviews-view-picker-grid__media", children: renderedMediaField }),
        showMedia && renderedMediaField && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        showTitle && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_ui.Stack,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dataviews-view-picker-grid__title-field dataviews-title-field", children: renderedTitleField })
          }
        ),
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  import_components.Flex,
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.FlexItem, { className: "dataviews-view-picker-grid__field-name", children: field.header }),
...
function ViewPickerGrid({
  ...
  const { resizeObserverRef, paginationInfo, itemListLabel } = (0, import_element.useContext)(import_dataviews_context.default);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    ...
    children: [
      hasData && groupField && dataByGroup && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ...
      hasData && !dataByGroup && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        import_components.Composite,
        {
      ...
      // Render empty state.
      !hasData && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "div",
        {
          className: (0, import_clsx.default)({
