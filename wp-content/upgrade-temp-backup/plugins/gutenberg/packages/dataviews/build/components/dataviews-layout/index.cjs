...
var dataviews_layout_exports = {};
__export(dataviews_layout_exports, {
  default: () => DataViewsLayout
});
module.exports = __toCommonJS(dataviews_layout_exports);
...
function DataViewsLayout({ className }) {
  const {
    ...
    renderItemLink,
    defaultLayouts,
    empty = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: (0, import_i18n.__)("No results") })
  } = (0, import_element.useContext)(import_dataviews_context.default);
  if (!hasInitiallyLoaded) {
    return null;
  }
  const ViewComponent = import_dataviews_layouts.VIEW_LAYOUTS.find(
